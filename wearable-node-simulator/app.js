...
//            "luminosity" : 5,
    ...
    setInterval(function(){
        ...
        //}
	dataPacket.d.heartRate = getRandomInt(50,110);
	sendVariables(dataPacket.d.heartRate,Date.now());
        /*if (dataPacket.d.temperature === 100) {
...
function sendVariables(bpm,timestamp){
var http = require("http");
var options = {
  hostname: 'projects.amitnandanp.com',
  port: 80,
  path: '/submitData.php',
  method: 'POST',
  headers: {
...
var req = http.request(options, function(res) {
  ...
  console.log('complete result: ' + res.body);
...
req.write('{"bpm": "'+bpm+'","timestamp":"'+timestamp+'"}');
req.end();
}
